...
Hard rules: the prompt and response are verbatim (the only modification is the 4-space line indentation), the agent suffix is always added, no secrets in the file (`.agents/rules/run.secret-safety.md`).
